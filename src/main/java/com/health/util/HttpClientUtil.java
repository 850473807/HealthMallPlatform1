...
public class HttpClientUtil {
    ...
    public static boolean checkCode(HttpServletRequest request, Long phone, String code) {
        Map<String, String> map = ContextModel.getCode(request);
        if (map == null) {
            return false;
        }
        ...
        return code1.equals(code) && String.valueOf(phone).equals(phone1) && new Date().getTime() - Long.parseLong(date1) < 5 * 60 * 1000;
    }

    public String sendMsgUtf8(Long phone) {
        String code = smsCode();
        String msg = "你的注册验证码为：" + code + "，请在5分钟内有效注册！";
        sendMsgUtf8("a850473807","d41d8cd98f00b204e980",msg,String.valueOf(phone));
        return code;
    }
}